<template>
  <div id="hao-she-ji" v-if="thisdata != null">
    <!--好设计-->
    <div class="wrap">
...
<script>
  import axios from 'axios'
    export default {
      ...
      mounted(){
          var that =this;
          axios.get('api/posts?design=bad&scene=%E5%85%A8%E9%83%A8').then(function (res) {
            //使用thisdata接收数据的数组
...
.zhong-B {
  border: 2px solid #f94815;
  background-color: rgba(249,72,21,0.2);
  width: 110px;
  height: 110px;
  border-radius: 50%;
  text-align: center;
